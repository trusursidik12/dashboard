<?php foreach($aqmdatarum as $rum) : ?>
    ...
    <div class="row text-white" style="margin-left:0px; margin-right:0px">
      <div class="col-4 card p-2 border" style="height: 580px">
        <canvas id="chartrumdatah2s" width="100" height="115"></canvas>
      </div>
      <div class="col-4 card p-2 border" style="height: 580px">
        <canvas id="chartrumdatacs2" width="100" height="115"></canvas>
      </div>
...
<script>
    $(function() {
      ...
      var UserVsMyAppsCtx = document.getElementById('chartrumdatah2s').getContext('2d');
...
<script>
    $(function() {
      ...
      var UserVsMyAppsCtx = document.getElementById('chartrumdatacs2').getContext('2d');
      var UserVsMyApps = new Chart(UserVsMyAppsCtx, {
          type: 'bar',
          data: UserVsMyAppsData,
          options: {
