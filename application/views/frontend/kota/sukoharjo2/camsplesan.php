    ...
    <div class="row" style="margin-left:0px; margin-right:0px">
      <div class="col-12  bg-col">
        <div class="p-1 text-center">
          <h5 style="font-size: 44px"><b>STASIUN AQMS PLESAN (<?= date('d-m-Y H:i', strtotime($plesan['waktu'])) ?>)</b></h5><br>
        </div>
      </div>
    </div>
    ...
    <div class="row text-white" style="margin-left:0px; margin-right:0px">
      ...
      <div class="col-4 card p-2 border bg-info">
        <div class="" style="margin-top: 40px; margin-bottom: 95px">
          ...
          <h6 class="text-center" style="font-size: 42px;"><b><?= $plesan['h2s'].'<a style="font-size: 16px;">[μg]</a>' ?> <br> <?= round($plesan['h2s'] / 1500, 3).'<a style="font-size: 16px;">[ppm]</a>' ?></b></h6>
        </div><hr style="border: 1px solid white">
        <div class="" style="margin-top: 40px; ">
          <h6 style="font-size: 22px"><b>CS2</b></h6>
          <h6 class="text-center" style="font-size: 42px"><b><?= $plesan['cs2'].'<a style="font-size: 16px;">[μg]</a>' ?> <br> <?= round($plesan['cs2'] / 3130, 3).'<a style="font-size: 16px;">[ppm]</a>' ?></b></h6>
        </div>
      </div>
    </div>
    <div class="row text-white" style="margin-left:0px; margin-right:0px">
      <div class="col card p-2 border  bg-info">
        <div class="">
          ...
          <h6 class="text-center" style="font-size: 32px;"><b><?= $plesan['ws'] ?></b></h6>
      ...
      <div class="col card p-2 border  bg-info">
        <div class="">
          ...
          <h6 class="text-center" style="font-size: 32px;"><b><?= $plesan['wd'] ?></b></h6>
      ...
      <div class="col card p-2 border  bg-info">
        <div class="">
          ...
          <h6 class="text-center" style="font-size: 32px;"><b><?= $plesan['humidity'] ?></b></h6>
          <a class="text-center" style="font-size: 16px; margin-bottom: 0px;">[%]</a>
        </div>
        <div class="p-1 border  bg-info">
          <div class="text-center">
      ...
      <div class="col card p-2 border  bg-info">
        <div class="">
          ...
          <h6 class="text-center" style="font-size: 32px;"><b><?= $plesan['temperature'] ?></b></h6>
      ...
      <div class="col card p-2 border  bg-info">
        <div class="">
          ...
          <h6 class="text-center" style="font-size: 32px;"><b><?= $plesan['pressure'] ?></b></h6>
      ...
      <div class="col card p-2 border  bg-info">
        <div class="">
          ...
          <h6 class="text-center" style="font-size: 32px;"><b><?= $plesan['sr'] ?></b></h6>
      ...
      <div class="col card p-2 border  bg-info">
        <div class="">
          ...
          <h6 class="text-center" style="font-size: 32px;"><b><?= $plesan['rain_intensity'] ?></b></h6>
