<?php foreach($aqmdatacemsrum as $cemsrum) : ?>
    ...
    <div class="row text-white" style="margin-left:0px; margin-right:0px">
      <div class="col-8 card p-2 border" style="height: 580px">
        <canvas id="chartcemsrumdata" width="100" height="55"></canvas>
      </div>
    ...
    <div class="row text-white" style="margin-left:0px; margin-right:0px">
      <div class="col card p-2 border  bg-info">
        <div class="">
          ...
          <h6 class="text-center" style="font-size: 32px;"><b><?= $cemsrum['ws'] ?></b></h6>
      ...
      <div class="col card p-2 border  bg-info">
        <div class="">
          ...
          <h6 class="text-center" style="font-size: 32px;"><b><?= $cemsrum['temperature'] ?></b></h6>
...
<script>
    $(function() {
      ...
      var UserVsMyAppsCtx = document.getElementById('chartcemsrumdata').getContext('2d');
