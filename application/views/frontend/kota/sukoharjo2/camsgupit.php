<?php foreach($aqmdatagupit as $gupit) : ?>
    <div class="row" style="margin-left:0px; margin-right:0px">
      <div class="col-12  bg-col">
        <div class="p-1 text-center">
          <h5 style="font-size: 44px"><b>STASIUN CAMS GUPIT (<?= date('d-m-Y H:i', strtotime($gupit['waktu'])) ?>)</b></h5><br>
        </div>
      </div>
    </div>
    ...
    <div class="row text-white" style="margin-left:0px; margin-right:0px">
      <div class="col-8 card p-2 border" style="height: 580px">
        <canvas id="chartgupitdata" width="100" height="55"></canvas>
      </div>
...
<script>
    $(function() {
      ...
      var UserVsMyAppsCtx = document.getElementById('chartgupitdata').getContext('2d');
