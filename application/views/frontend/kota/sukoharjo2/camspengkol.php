<?php foreach($aqmdatapengkol as $pengkol) : ?>
    <div class="row" style="margin-left:0px; margin-right:0px">
      <div class="col-12  bg-col">
        <div class="p-1 text-center">
          <h5 style="font-size: 44px"><b>STASIUN AQMS PENGKOL (<?= date('d-m-Y H:i', strtotime($pengkol['waktu'])) ?>)</b></h5><br>
        </div>
      </div>
    </div>
    ...
    <div class="row text-white" style="margin-left:0px; margin-right:0px">
      <div class="col-4 card p-2 border" style="height: 580px;">
        <canvas id="chartpengkoldatah2s" width="100" height="115"></canvas>
      </div>
      <div class="col-4 card p-2 border" style="height: 580px;">
        <canvas id="chartpengkoldatacs2" width="100" height="115"></canvas>
      </div>
      <div class="col-4 card p-2 border bg-info">
        <div class="" style="margin-top: 40px; margin-bottom: 95px">
          ...
          <h6 class="text-center" style="font-size: 42px;"><b><?= $pengkol['h2s'].'<a style="font-size: 16px;">[μg]</a>' ?> <br> <?= round($pengkol['h2s'] / 1500, 3).'<a style="font-size: 16px;">[ppm]</a>' ?></b></h6>
        </div><hr style="border: 1px solid white">
        <div class="" style="margin-top: 40px; ">
          <h6 style="font-size: 22px"><b>CS2</b></h6>
          <h6 class="text-center" style="font-size: 42px"><b><?= $pengkol['cs2'].'<a style="font-size: 16px;">[μg]</a>' ?> <br> <?= round($pengkol['cs2'] / 3130, 3).'<a style="font-size: 16px;">[ppm]</a>' ?></b></h6>
        </div>
      </div>
    </div>
    <div class="row text-white" style="margin-left:0px; margin-right:0px">
      <div class="col card p-2 border  bg-info">
        <div class="">
          ...
          <h6 class="text-center" style="font-size: 32px;"><b><?= $pengkol['ws'] ?></b></h6>
      ...
      <div class="col card p-2 border  bg-info">
        <div class="">
          ...
          <h6 class="text-center" style="font-size: 32px;"><b><?= $pengkol['wd'] ?></b></h6>
      ...
      <div class="col card p-2 border  bg-info">
        <div class="">
          ...
          <h6 class="text-center" style="font-size: 32px;"><b><?= $pengkol['humidity'] ?></b></h6>
          <a class="text-center" style="font-size: 16px; margin-bottom: 0px;">[%]</a>
        </div>
        <div class="p-1 border  bg-info">
          <div class="text-center">
      ...
      <div class="col card p-2 border  bg-info">
        <div class="">
          ...
          <h6 class="text-center" style="font-size: 32px;"><b><?= $pengkol['temperature'] ?></b></h6>
      ...
      <div class="col card p-2 border  bg-info">
        <div class="">
          ...
          <h6 class="text-center" style="font-size: 32px;"><b><?= $pengkol['pressure'] ?></b></h6>
      ...
      <div class="col card p-2 border  bg-info">
        <div class="">
          ...
          <h6 class="text-center" style="font-size: 32px;"><b><?= $pengkol['sr'] ?></b></h6>
      ...
      <div class="col card p-2 border  bg-info">
        <div class="">
          ...
          <h6 class="text-center" style="font-size: 32px;"><b><?= $pengkol['rain_intensity'] ?></b></h6>
...
<script>
    $(function() {
       const data = [
        <?php foreach($aqmdatapengkol as $chartpengkol) : ?>
          <?= $chartpengkol['h2s'] ?>
        <?php endforeach ?>
      ];
      ...
      var UserVsMyAppsCtx = document.getElementById('chartpengkoldatah2s').getContext('2d');
...
<script>
    $(function() {
      ...
      var UserVsMyAppsCtx = document.getElementById('chartpengkoldatacs2').getContext('2d');
      var UserVsMyApps = new Chart(UserVsMyAppsCtx, {
          type: 'bar',
          data: UserVsMyAppsData,
          options: {
