  ...
  <div class="row" style="margin-top: -20px">
    ...
    <div class="col-6">
      <div class="card p-3 border bg-col">
        <h6><b>H2S</b></h6>
        <h6 class="text-center"><b><?= $plesan['h2s'].'<a style="font-size: 14px;">[μg]</a>' ?> | <?= round($plesan['h2s'] / 1500, 3).'<a style="font-size: 14px;">[ppm]</a>' ?></b></h6>
      </div>
    </div>
    <div class="col-6">
      <div class="card p-3 border bg-col">
        <h6><b>CS2</b></h6>
        <h6 class="text-center"><b><?= $plesan['cs2'].'<a style="font-size: 14px;">[μg]</a>' ?> | <?= round($plesan['cs2'] / 3130, 3).'<a style="font-size: 14px;">[ppm]</a>' ?></b></h6>
      </div>
    </div>
    <div class="col-12">
      <div class="row">
