  ...
  <div class="row">
    ...
    <div class="col-6">
      <div class="card p-3 border bg-col">
        <h5><b>H2S</b></h5>
        <h2 class="text-center"><b><?= $plesan['h2s'].'<a style="font-size: 14px;">[μg]</a>' ?> | <?= round($plesan['h2s'] / 1500, 3).'<a style="font-size: 14px;">[ppm]</a>' ?></b></h2>
      </div>
    </div>
    <div class="col-6">
      <div class="card p-3 border bg-col">
        <h5><b>CS2</b></h5>
        <h2 class="text-center"><b><?= $plesan['cs2'].'<a style="font-size: 14px;">[μg]</a>' ?> | <?= round($plesan['cs2'] / 3130, 3).'<a style="font-size: 14px;">[ppm]</a>' ?></b></h2>
      </div>
    </div>
    <div class="col-12">
      <div class="row">
