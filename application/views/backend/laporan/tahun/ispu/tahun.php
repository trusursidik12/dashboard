          ...
          <div class="card-body table-responsive">
            <div class="row">
              <div class="col-md-10 col-md-offset-2">
                <form class="form-inline"  method="post" action="<?= site_url('laporan/ispu/tahun') ?>">
                              ...
                              <td>
                                <?php if(!empty($maxispu)) : ?>
                                  <?php foreach($maxispu as $berlaku) : ?>
                                    <?= date('Y', strtotime($berlaku['waktu'])) ?>
                                    <?php break ?>
                                  <?php endforeach ?>
                                <?php else : ?>
                                  <?= "Tahun" ?>
                  ...
                  <table class="table table-bordered table-striped text-center" width="100%">
                    ...
                    <tbody>
                      <?php foreach($maxispu as $maxispuparams) : ?>
                        <?php if(date('m', strtotime($maxispuparams['waktu'])) == str_pad($m,2,'0',STR_PAD_LEFT)) : ?>
                          <tr class="text-center">
